...
class MvolaScreen extends StatefulWidget {
  final AbonnementModel abonnement;

  const MvolaScreen({super.key, required this.abonnement});

  @override
  _MvolaScreenState createState() => _MvolaScreenState();
}

class _MvolaScreenState extends State<MvolaScreen>
  ...
  String? _validatePhone(String? value) {
    ...
    if (!RegExp(r'^(032|033|034|038)\d{7}$').hasMatch(value)) {
      return 'Numéro MVola invalide (ex: 034XXXXXXX)';
    }
    return null;
  }
  ...
  Future<void> _proceedToPayment() async {
    ...
    // Simulation du processus de paiement MVola
                    ...
                    Row(
                      children: [
                        Container(
                          ...
                          height: 40,
                          decoration: BoxDecoration(
                            color: Color(0xFF6E00FF).withOpacity(0.2),
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              Text(
                                'Confirmez le paiement dans votre appli MVola',
                                style: TextStyle(
                                  color: Colors.white,
                                  fontSize: 14,
        ...
        children: [
              ...
              return Transform.scale(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    gradient: LinearGradient(
                      colors: [
                        Color(0xFF6E00FF).withOpacity(0.3),
                        Color(0xFF9B51E0).withOpacity(0.3),
                      ],
                    ),
                  ),
                ),
          ...
          Container(
            ...
            decoration: BoxDecoration(
              shape: BoxShape.circle,
              gradient: LinearGradient(
                colors: [Color(0xFF6E00FF), Color(0xFF9B51E0)],
                begin: Alignment.topLeft,
                end: Alignment.bottomRight,
              ),
              boxShadow: [
                BoxShadow(
                  color: Color(0xFF6E00FF).withOpacity(0.4),
                  blurRadius: 25,
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          Expanded(
            child: Text(
              'Vous recevrez une notification pour confirmer le paiement via #111#',
              style: TextStyle(
                color: Colors.white.withOpacity(0.7),
                fontSize: 13,
                fontWeight: FontWeight.w500,
